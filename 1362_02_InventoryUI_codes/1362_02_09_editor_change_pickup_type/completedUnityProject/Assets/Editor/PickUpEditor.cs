...
public class PickUpEditor : Editor
{
	...
	void OnEnable () {
		iconHealth = Resources.LoadAssetAtPath("Assets/EditorSprites/icon_heart_32.png", typeof(Texture)) as Texture;
		...
		spriteHealth100 = Resources.LoadAssetAtPath("Assets/EditorSprites/healthheart.png", typeof(Sprite)) as Sprite;
		spriteKey100 = Resources.LoadAssetAtPath("Assets/EditorSprites/icon_key_green_100.png", typeof(Sprite)) as Sprite;
		spriteStar100 = Resources.LoadAssetAtPath("Assets/EditorSprites/star.png", typeof(Sprite)) as Sprite;
