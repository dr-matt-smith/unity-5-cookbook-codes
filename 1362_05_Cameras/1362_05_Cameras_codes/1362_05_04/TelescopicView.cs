...
public class TelescopicView : MonoBehaviour{
	...
	// VignetteAndChromaticAberration variable for referencing image effect (Unity Pro only)
	//private VignetteAndChromaticAberration v;
	// float variable for the maximum intensity of vignetting allowed (Unity Pro only)
